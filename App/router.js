...
router
    .get("/", async (ctx) => {
        ctx.render("Templates/index.ejs"); //issue with background img
    })
    .get("/projects", async (ctx) => {
        ctx.render("Templates/projects.ejs", {});
    })
    .get("/contact-us", async (ctx, next) => {
        ctx.render("Templates/contact-us.ejs", {});
    })
    .get("/services", async (ctx, next) => {
        ctx.render("Templates/services.ejs", {});
    });
